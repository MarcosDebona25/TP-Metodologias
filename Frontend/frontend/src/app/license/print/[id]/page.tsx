      ...
      <div className="bg-white rounded-xl shadow-lg w-[750px] h-[400px] p-4 relative text-[14px] text-black font-sans print:shadow-none">
        ...
        <div className="flex mt-2">
          ...
          <div className="w-3/4 pl-4 grid grid-cols-2 gap-1">
            <p>
              <b>N° Licencia:</b> {license.documentoTitular}
            </p>
            <p>
              <b>Clases:</b> {license.clases}
            </p>
            <p>
              <b>Apellido:</b> {license.apellidoTitular}
            </p>
            <p>
              <b>Nombre:</b> {license.nombreTitular}
            </p>
            <p>
              <b>Domicilio:</b> {license.domicilioTitular}
            </p>
            <p>
              <b>Fecha de Nac.:</b> {formatear(person.fechaNacimiento)}
            </p>
            <p>
              <b>Otorgamiento:</b> {formatear(license.fechaEmisionLicencia)}
            </p>
            <p>
              <b>Vencimiento:</b> {formatear(license.fechaVencimientoLicencia)}
            </p>
            <p>
              <b>Donante de Órganos:</b> {license.donanteOrganos}
            </p>
            <p>
              <b>Grupo y Factor:</b> {license.grupoFactor}
            </p>
            <p className="col-span-2">
              <b>Observaciones:</b> {license.observacionesLicencia}
            </p>
          </div>
        </div>
